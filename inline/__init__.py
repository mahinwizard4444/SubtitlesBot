...
def inlinequery(update, context):
    ...
    inline = [
        [
            InlineKeyboardButton("Our Group", url="https://telegram.dog/TvSeriesLand4U"),
            InlineKeyboardButton("Our Channel", url="https://telegram.dog/TvSeriesLand4U_Updates")
        ]
    ]
    results = [
        InlineQueryResultDocument(
